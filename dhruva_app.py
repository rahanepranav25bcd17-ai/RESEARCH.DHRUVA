...
st.markdown("""
    ...
    .protocol-box { border: 1px solid #7B0000; padding: 20px; background-color: #050000; font-family: 'Courier New', monospace; color: #FF4B4B; margin-top: 40px; }
    ...
    .email-text { color: #2ECC71 !important; font-weight: bold; font-size: 22px; text-decoration: none; }
...
with tab1:
    ...
    st.markdown("""
        ...
        <h4>🛡️ D.H.R.U.V.A. PROTOCOLS</h4>
        <ul>
            <li><b>LOGIC FIRST:</b> Every anomaly must be tested against known laws of physics.</li>
            <li><b>DATA INTEGRITY:</b> No evidence shall be fabricated or ignored.</li>
            <li><b>FEARLESS RESEARCH:</b> We walk where science stops and myth begins.</li>
        </ul>
        </div>
    """, unsafe_allow_html=True)
...
with tab2:
    ...
    with col_dir2:
        ...
        st.caption("Founder & Lead Investigator | Student at IIIT Kottayam")
        st.write("We are a specialized research unit dedicated to understanding unexplained phenomena through the lens of physics, engineering, and logic.")
            ...
            with st.form("pub_case"):
                ...
                if st.form_submit_button("PUBLISH LIVE"):
                    if conn:
                        ...
                        except: st.error("Sheet Update failed.")
